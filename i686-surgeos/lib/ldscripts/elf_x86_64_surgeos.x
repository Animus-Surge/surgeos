...
ENTRY(_start)
SEARCH_DIR("=/home/surge/projects/surgeos/.opt/i686-surgeos/lib");
SECTIONS
{
  /* Read-only sections, merged into text segment: */
  PROVIDE (__executable_start = SEGMENT_START("text-segment", 0x08000000));
  . = SEGMENT_START("text-segment", 0x08000000) + SIZEOF_HEADERS;
